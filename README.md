...
# CBOM
java -jar target/runtime-analyst-1.0.jar cbom

# AI-BOM
java -jar target/runtime-analyst-1.0.jar aibom
```
...
Creates `target/runtime-analyst-1.0.jar` (executable uber-jar; `Main` dispatches to `cbom`/`aibom` based on the first argument).
