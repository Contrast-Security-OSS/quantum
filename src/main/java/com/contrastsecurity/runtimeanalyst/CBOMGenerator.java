 ...
 *
 * Usage:
 *   java -jar runtime-analyst.jar cbom                      # Fetch all apps, output cbom.json
 *   java -jar runtime-analyst.jar cbom --app "AppName"      # Fetch single app
 *   java -jar runtime-analyst.jar cbom --list               # List available apps
 *   java -jar runtime-analyst.jar cbom -o custom.json       # Custom output filename
...
public class CBOMGenerator {
    ...
    private static void printUsage() {
        ...
        System.out.println("\nUsage:");
        System.out.println("  java -jar runtime-analyst.jar cbom                    Generate CBOM for all apps");
        System.out.println("  java -jar runtime-analyst.jar cbom --app <id|name>    Filter by app (ID or name)");
        System.out.println("  java -jar runtime-analyst.jar cbom --env <tier>       Filter by environment (PRODUCTION, DEVELOPMENT, QA)");
        System.out.println("  java -jar runtime-analyst.jar cbom --list             List available applications with IDs");
        System.out.println("  java -jar runtime-analyst.jar cbom --analyze          Run Quantum Advisor AI analysis after CBOM generation");
        ...
        System.out.println("\nExamples:");
        System.out.println("  java -jar runtime-analyst.jar cbom                          # all apps -> cbom.json");
        System.out.println("  java -jar runtime-analyst.jar cbom --env PRODUCTION         # only prod observations");
        System.out.println("  java -jar runtime-analyst.jar cbom --app MyApp --env PRODUCTION");
        System.out.println("  java -jar runtime-analyst.jar cbom --analyze                # generate CBOM + AI analysis report");
        System.out.println("  java -jar runtime-analyst.jar cbom -c prod.properties --list");
    }
